...
<div class="dropdown-divider"></div>
<a class="dropdown-item" href="{{config('neayi.wiki_url')}}/wiki/Search?filters=A+un+type+de+page%5E%5EPratique&order=desc&ordertype=Modification+date" title="Suche nach Praxen">Suche nach Praxen</a>
