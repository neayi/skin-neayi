...
<a class="dropdown-item" href="{{config('neayi.wiki_url')}}/wiki/Retours_d%27expérience" title="Rechercher des retours d’expérience">Rechercher des retours d’expérience</a>
<a class="dropdown-item" href="{{config('neayi.wiki_url')}}/wiki/Portraits_de_ferme" title="Rechercher des portraits de ferme">Rechercher des portraits de ferme</a>
...
<a class="dropdown-item" href="{{config('neayi.wiki_url')}}/wiki/Couverts végétaux" title="Couverts végétaux">Couverts végétaux</a>
...
<a class="dropdown-item" href="{{config('neayi.wiki_url')}}/wiki/Désherbage" title="Désherbage">Désherbage</a>
<a class="dropdown-item" href="{{config('neayi.wiki_url')}}/wiki/Diagnostic et performance d'une ferme" title="Diagnostic et performance">Diagnostic et performance</a>
...
<a class="dropdown-item" href="{{config('neayi.wiki_url')}}/wiki/Transmettre sa ferme" title="Transmettre sa ferme">Transmettre sa ferme</a>
...
<div class="dropdown-divider"></div>
<a class="dropdown-item" href="{{config('neayi.wiki_url')}}/wiki/Search?filters=A+un+type+de+page%5E%5EPratique&order=desc&ordertype=Modification+date" title="Rechercher des pratiques">Rechercher des pratiques</a>
