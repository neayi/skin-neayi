...
MENU;
    ...
    $strMenu .= '<li class="nav-item neayi-additional-mobile-menus"><a class="nav-link" onclick="window.scrollTo(0, 0); $(\'#searchInput\').focus(); return true" data-toggle="collapse" href="#" title="'.$_["search"].'">'.$_["search"].'</a></li>' . PHP_EOL;
